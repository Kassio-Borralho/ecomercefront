<script setup>
import CarMarket from '@/components/icons/CarMarket.vue';
</script>
<template>
    <div
        class=" flex w-full md:max-w-64 lg:max-w-72 flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
